...
%-----------------------------------------------------------------
\titleind{Pemanfaatan General Purpose GPU berdasar Bahasa Pemrograman Julia untuk Komputasi Berunjuk Kerja Tinggi}

\titleeng{Implementation of General Purpose GPU based on the Julia Programming Language for High Performance Computation}

\fullname{Moh Rizal Alfarizi}
\NIM{19/445591/PA/19415}
\yearenrollment{2019}
\examdate{(Menyesuaikan)}
\degree{Sarjana}
\yearsubmit{2024}
