...
data random yang di-\emph{generate} oleh Julia menggunakan fungsi \cw{rand()}
dengan mengatur \emph{seed} \cw{101}.
...
software Pluto dalam mengeksekusi operasi yang ada. Pada Gambar
...
pengecekan variasi percobaan. Setiap operasi matriks terdapat 5 variasi
pengukuran berdasarkan ukuran matriks nya. Berikut merupakan 5 variasi
pengukuran nya:

\begin{itemize}
  \item Variasi 1: Matriks berukuran $100 \times 100$
  \item Variasi 2: Matriks berukuran $1000 \times 1000$
  \item Variasi 3: Matriks berukuran $10^4 \times 10^4$
  \item Variasi 4: Matriks berukuran $10^5 \times 10^5$
  \item Variasi 5: Matriks berukuran $10^6 \times 10^6$
\end{itemize}
